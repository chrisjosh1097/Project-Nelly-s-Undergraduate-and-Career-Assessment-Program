...
export const constraintRules: ConstraintRule[] = [
  createConstraintRule({
    ...
    boostMajorIds: ["kesehatan_masyarakat", "gizi", "teknologi_laboratorium_medis", "administrasi_publik", "pendidikan_guru_sekolah_dasar"],
    cautionMajorIds: ["kedokteran", "kedokteran_gigi", "kedokteran_hewan", "farmasi"],
    alternativeMajorIds: ["kesehatan_masyarakat", "gizi", "teknologi_laboratorium_medis", "keperawatan"],
    scoringModifier: -8,
    advice: [
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["administrasi_perkantoran", "digital_marketing_applied", "pendidikan_guru_sekolah_dasar", "manajemen", "akuntansi"],
    cautionMajorIds: ["kedokteran", "kedokteran_gigi", "artificial_intelligence", "game_technology"],
    alternativeMajorIds: ["sistem_informasi", "manajemen", "komunikasi", "akuntansi"],
    scoringModifier: -4,
    advice: [
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["teknologi_laboratorium_medis", "kesehatan_masyarakat", "sistem_informasi", "administrasi_bisnis", "vokasi_teknik"],
    cautionMajorIds: ["kedokteran", "kedokteran_gigi", "informatika", "aktuaria", "arsitektur"],
    alternativeMajorIds: ["sistem_informasi", "teknologi_informasi", "statistika", "kesehatan_masyarakat", "teknik_industri"],
    scoringModifier: -5,
    advice: [
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["sistem_informasi", "manajemen", "komunikasi", "psikologi", "bisnis_digital", "pendidikan_guru_sekolah_dasar"],
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["vokasi_teknik", "teknik_otomotif", "teknologi_informasi", "digital_marketing_applied", "rekam_medis", "keperawatan", "administrasi_perkantoran"],
    cautionMajorIds: ["biologi", "sosiologi", "ilmu_politik"],
    alternativeMajorIds: ["teknologi_informasi", "digital_marketing_applied", "rekam_medis", "vokasi_teknik"],
    scoringModifier: 8,
    advice: [
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["farmasi", "kesehatan_masyarakat", "teknik_lingkungan", "pendidikan_matematika", "statistika"],
    cautionMajorIds: ["kedokteran", "kedokteran_gigi"],
    alternativeMajorIds: ["kesehatan_masyarakat", "gizi", "teknologi_laboratorium_medis", "farmasi"],
    scoringModifier: 2,
    advice: [
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["informatika", "manajemen", "hukum", "teknik_industri", "kesehatan_masyarakat"],
    cautionMajorIds: ["kedokteran", "informatika", "aktuaria"],
    alternativeMajorIds: ["sistem_informasi", "teknik_industri", "statistika", "administrasi_publik"],
    scoringModifier: 1,
    advice: [
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["teknik_lingkungan", "agroteknologi", "perikanan", "kehutanan", "teknik_sipil"],
    cautionMajorIds: [],
    alternativeMajorIds: ["agribisnis", "ilmu_lingkungan", "teknik_logistik"],
    scoringModifier: 2,
    advice: [
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["bisnis_digital", "desain_komunikasi_visual", "sistem_informasi", "komunikasi", "uiux_design_applied"],
    cautionMajorIds: [],
    alternativeMajorIds: ["digital_marketing_applied", "uiux_design_applied", "teknologi_informasi"],
    scoringModifier: 3,
    advice: [
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["manajemen", "akuntansi", "pendidikan_guru_sekolah_dasar", "administrasi_perkantoran", "keperawatan"],
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["vokasi_teknik", "teknik_otomotif", "teknik_pendingin_tata_udara", "rekam_medis", "digital_marketing_applied", "uiux_design_applied", "tata_boga"],
    cautionMajorIds: ["biologi", "ilmu_politik", "linguistik"],
    alternativeMajorIds: ["vokasi_teknik", "rekam_medis", "digital_marketing_applied", "tata_boga"],
    scoringModifier: 8,
    advice: [
  ...
  createConstraintRule({
    ...
    boostMajorIds: ["digital_marketing_applied", "uiux_design_applied", "teknologi_informasi", "cybersecurity", "tata_rias", "teknik_otomotif"],
    cautionMajorIds: ["kedokteran", "kedokteran_gigi", "hukum"],
    alternativeMajorIds: ["teknologi_informasi", "digital_marketing_applied", "uiux_design_applied", "vokasi_teknik"],
    scoringModifier: 7,
    advice: [
